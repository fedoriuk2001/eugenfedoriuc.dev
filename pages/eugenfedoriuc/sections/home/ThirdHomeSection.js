      ...
      <div className="text-center py-8 xl:py-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16 mb-12 lg:mb-24">
          <div className="flex -mx-3 text-left">
            <div className="mx-3">
              <div className="bg-[#555555] rounded-lg p-4 w-16 h-16 grid place-items-center">
                <svg
                  aria-hidden="true"
                  focusable="false"
                  data-prefix="fal"
            ...
            <div className="mx-3">
              <h3 className="text-2xl mb-4">Website Review</h3>
              <p>
          ...
          <div className="flex -mx-3 text-left">
            ...
            <div className="mx-3">
              <h3 className="text-2xl mb-4">Business Strategy</h3>
              <p>
          ...
          <div className="flex -mx-3 text-left">
            ...
            <div className="mx-3">
              <h3 className="text-2xl mb-4">User Experience Design</h3>
              <p>
          ...
          <div className="flex -mx-3 text-left">
            ...
            <div className="mx-3">
              <h3 className="text-2xl mb-4">Tailored Development</h3>
              <p>
          ...
          <div className="flex -mx-3 text-left">
            ...
            <div className="mx-3">
              <h3 className="text-2xl mb-4">Rigorous Testing</h3>
              <p>
          ...
          <div className="flex -mx-3 text-left">
            <div className="mx-3">
              <div className="bg-[#555555] rounded-lg p-4 w-16 h-16 grid place-items-center">
                <svg
                  ...
                  data-prefix="fal"
                  data-icon="headset"
                  className="svg-inline--fa fa-headset fa-w-16 text-2xl"
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                >
            ...
            <div className="mx-3">
              <h3 className="text-2xl mb-4">Ongoing Support</h3>
              <p>
