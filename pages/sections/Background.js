...
export default function Background() {
  ...
  return (
    <div className="relative w-full min-w-screen xl:overflow-auto ">
      <div className=" min-h-[828px] xl:hidden absolute top-0 left-0 right-0 flex items-center pl-4 pr-20 py-4 transition-all duration-500">
        <nav className="z-0">
          <div className="mb-8">
          ...
          <ul className="list-none">
            <li className="relative">
              <span className="flex items-center">
                <a className="block text-inverted font-semibold p-3 flex items-center" href="#" >
