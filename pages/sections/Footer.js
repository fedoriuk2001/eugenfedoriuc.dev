              ...
              <div className="container">
                <div className="pt-32">
                  <div className="flex mb-6">
                    <div
                      className=" relativerounded-full block overflow-hidden"
                    >
                  ...
                  <div className="grid md:grid-cols-12 gap-4">
                    <div className="md:col-span-5 grid gap-4 mb-auto">
                      ...
                      <div>
                        <p>
                          I create beautiful websites your users will love. I
                          work with you from start to finish to make sure your
                          goals are reached and your users are happy.
                        </p>

                        <p>
                          <a href="https://skyward.digital"
                            >See Skyward, our new agency</a
                          >
                        </p>
                      </div>
                      <div className="-mx-4">
                  ...
                  <div className="grid md:grid-cols-12 my-6">
                    <div className="md:col-span-5">
                      <div>
                        <p><strong>Join the newsletter</strong></p>
